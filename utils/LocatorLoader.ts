...
export class LocatorLoader {
     ...
     * 
     * @param pageName - The name of the page (e.g., 'LoginPage', 'InventoryPage').
     * @returns The object containing locators for the page.
     * @throws Will throw an error if the file cannot be read or parsed.
     */
    static load(pageName: string) {
     ...
     * 
     * @param pageName - The name of the page (e.g., 'LoginPage').
     * @param key - The key of the locator within the YAML file (e.g., 'usernameInput').
     * @returns The locator string.
     * @throws Will throw an error if the locator is not found.
     */
    static get(pageName: string, key: string): string {
